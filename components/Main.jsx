    ...
    return (
        <RevealOnScroll>
            <div id="home" className='w-full h-screen text-center'>
                <div className='max-w-[1240px] w-full h-screen mx-auto p-2 flex justify-center items-center pb-0'>
                    <div>
                        <p className='uppercase text-sm tracking-widest text-gray-500'>Welcome</p>
                        <h1 className='py-2 text-gray-700'>Hi, I'm <span className='text-[#5651e5]'>Hari Kishore</span></h1>
                        ...
                        <div className='flex items-center justify-between max-w-[330px] m-auto pt-2'>
