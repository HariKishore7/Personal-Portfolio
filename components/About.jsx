...
const About = () => {
    return (
        <RevealOnScroll>
            <div id="about" className='w-full md:h-auto p-2 flex items-center py-2'>
                <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-6 pt-2'>
                    <div className='col-span-2'>
                        <p className='uppercase text-xl tracking-widest text-[#5651e5]'>About</p>
                        <h2 className='py-1'>Who I Am</h2>
